...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [sliderVC.navigationController.navigationBar setBarStyle:UIBarStyleBlack];
    [sliderVC.navigationController.navigationBar setHidden:YES];
