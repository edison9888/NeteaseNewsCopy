...
@interface PostNewsViewController () <MJRefreshBaseViewDelegate>
...
{
    [super viewDidLoad];
	NSString *jsonContent = [HttpRequest getNewsListByModelid:11 AndPagesize:10 AndPage:1];
    _arrNews = [[NSMutableArray alloc] initWithArray:[JsonParse parseNewsListByJson:jsonContent]];
...
- (void)getNewsWithPage:(int)page{
    NSString *jsonContent = [HttpRequest getNewsListByModelid:11 AndPagesize:5 AndPage:page];
