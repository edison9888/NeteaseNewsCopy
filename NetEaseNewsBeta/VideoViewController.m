...
- (void)getNewsWithPage:(int)page{
    NSString *jsonContent = [HttpRequest getNewsListByModelid:4 AndPagesize:5 AndPage:page];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    NewsDetailVideoVC *vc = [[NewsDetailVideoVC alloc] init];
    vc.videoNews = [self.arrNews objectAtIndex:indexPath.row];
